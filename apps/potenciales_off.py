...
df = pd.read_csv(DATA_PATH.joinpath("potenciales_off.csv"))
...
fig1.add_trace(
    go.Scatter(x=df1['fecha'], y=df1.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig1.update_layout(title="Potencial OFF CMP 006", coloraxis=dict(colorscale='Bluered_r'),
...
fig2.add_trace(
    go.Scatter(x=df2['fecha'], y=df2.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig2.update_layout(title="Potencial OFF CMP 010", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig3.add_trace(
    go.Scatter(x=df3['fecha'], y=df3['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig3.add_trace(
    go.Scatter(x=df3['fecha'], y=df3.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig3.update_layout(title="Potencial OFF CMP 017", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig4.add_trace(
    go.Scatter(x=df4['fecha'], y=df4['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig4.add_trace(
    go.Scatter(x=df4['fecha'], y=df4.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig4.update_layout(title="Potencial OFF CMP 021", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig5.add_trace(
    go.Scatter(x=df5['fecha'], y=df5['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig5.add_trace(
    go.Scatter(x=df5['fecha'], y=df5.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig5.update_layout(title="Potencial OFF CMP 034", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig6.add_trace(
    go.Scatter(x=df6['fecha'], y=df6['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig6.add_trace(
    go.Scatter(x=df6['fecha'], y=df6.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig6.update_layout(title="Potencial OFF CMP 043", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig7.add_trace(
    go.Scatter(x=df7['fecha'], y=df7['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig7.add_trace(
    go.Scatter(x=df7['fecha'], y=df7.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig7.update_layout(title="Potencial OFF CMP 056", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig8.add_trace(
    go.Scatter(x=df8['fecha'], y=df8['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig8.add_trace(
    go.Scatter(x=df8['fecha'], y=df8.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig8.update_layout(title="Potencial OFF CMP 071", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig9.add_trace(
    go.Scatter(x=df9['fecha'], y=df9['potencial'], mode="lines", marker_color='rgba(229, 45, 35, 1)', opacity=0.5,
               showlegend=False, hoverinfo="skip"), row=1, col=1)
fig9.add_trace(
    go.Scatter(x=df9['fecha'], y=df9.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)', name="Potencial OFF"),
    row=1, col=1)
fig9.update_layout(title="Potencial OFF CMP 084", coloraxis=dict(colorscale='Bluered_r'),
                   xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig10.add_trace(go.Scatter(x=df10['fecha'], y=df10.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig10.update_layout(title="Potencial OFF CMP 090", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig11.add_trace(go.Scatter(x=df11['fecha'], y=df11.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig11.update_layout(title="Potencial OFF CMP 101", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig12.add_trace(go.Scatter(x=df12['fecha'], y=df12.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig12.update_layout(title="Potencial OFF CMP 105", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig13.add_trace(go.Scatter(x=df13['fecha'], y=df13.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig13.update_layout(title="Potencial OFF CMP 122", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig14.add_trace(go.Scatter(x=df14['fecha'], y=df14.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig14.update_layout(title="Potencial OFF CMP 143", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig15.add_trace(go.Scatter(x=df15['fecha'], y=df15.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig15.update_layout(title="Potencial OFF CMP 153", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig16.add_trace(go.Scatter(x=df16['fecha'], y=df16.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig16.update_layout(title="Potencial OFF CMP 173", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig17.add_trace(go.Scatter(x=df17['fecha'], y=df17.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig17.update_layout(title="Potencial OFF CMP 184", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig18.add_trace(go.Scatter(x=df18['fecha'], y=df18.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig18.update_layout(title="Potencial OFF CMP 203", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig19.add_trace(go.Scatter(x=df19['fecha'], y=df19.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig19.update_layout(title="Potencial OFF CMP 220", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig20.add_trace(go.Scatter(x=df20['fecha'], y=df20.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig20.update_layout(title="Potencial OFF CMP 221 02AN", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig21.add_trace(go.Scatter(x=df21['fecha'], y=df21.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig21.update_layout(title="Potencial OFF CMP 236", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig22.add_trace(go.Scatter(x=df22['fecha'], y=df22.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig22.update_layout(title="Potencial OFF CMP 245", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig23.add_trace(go.Scatter(x=df23['fecha'], y=df23.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig23.update_layout(title="Potencial OFF CMP 249", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig24.add_trace(go.Scatter(x=df24['fecha'], y=df24.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig24.update_layout(title="Potencial OFF CMP 259", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig25.add_trace(go.Scatter(x=df25['fecha'], y=df25.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig25.update_layout(title="Potencial OFF CMP 271", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig26.add_trace(go.Scatter(x=df26['fecha'], y=df26.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig26.update_layout(title="Potencial OFF CMP 278", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig27.add_trace(go.Scatter(x=df27['fecha'], y=df27.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig27.update_layout(title="Potencial OFF CMP 284", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig28.add_trace(go.Scatter(x=df28['fecha'], y=df28.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig28.update_layout(title="Potencial OFF CMP 289", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig29.add_trace(go.Scatter(x=df29['fecha'], y=df29.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig29.update_layout(title="Potencial OFF CMP 295", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig30.add_trace(go.Scatter(x=df30['fecha'], y=df30.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig30.update_layout(title="Potencial OFF CMP 300", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig31.add_trace(go.Scatter(x=df31['fecha'], y=df31.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig31.update_layout(title="Potencial OFF CMP 307", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig32.add_trace(go.Scatter(x=df32['fecha'], y=df32.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig32.update_layout(title="Potencial OFF CMP 312", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig33.add_trace(go.Scatter(x=df33['fecha'], y=df33.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig33.update_layout(title="Potencial OFF CMP 318", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig34.add_trace(go.Scatter(x=df34['fecha'], y=df34.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig34.update_layout(title="Potencial OFF CMP 326", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig35.add_trace(go.Scatter(x=df35['fecha'], y=df35.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig35.update_layout(title="Potencial OFF CMP 332", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig36.add_trace(go.Scatter(x=df36['fecha'], y=df36.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig36.update_layout(title="Potencial OFF CMP 337", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig37.add_trace(go.Scatter(x=df37['fecha'], y=df37.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig37.update_layout(title="Potencial OFF CMP 345", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig38.add_trace(go.Scatter(x=df38['fecha'], y=df38.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig38.update_layout(title="Potencial OFF CMP 350", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig39.add_trace(go.Scatter(x=df39['fecha'], y=df39.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig39.update_layout(title="Potencial OFF CMP 363", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig40.add_trace(go.Scatter(x=df40['fecha'], y=df40.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig40.update_layout(title="Potencial OFF CMP 368", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig41.add_trace(go.Scatter(x=df41['fecha'], y=df41.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig41.update_layout(title="Potencial OFF CMP 375", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig42.add_trace(go.Scatter(x=df42['fecha'], y=df42.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig42.update_layout(title="Potencial OFF CMP 380", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig43.add_trace(go.Scatter(x=df43['fecha'], y=df43.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig43.update_layout(title="Potencial OFF CMP 388", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig44.add_trace(go.Scatter(x=df44['fecha'], y=df44.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig44.update_layout(title="Potencial OFF CMP 389", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig45.add_trace(go.Scatter(x=df45['fecha'], y=df45.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig45.update_layout(title="Potencial OFF CMP 395", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig46.add_trace(go.Scatter(x=df46['fecha'], y=df46.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig46.update_layout(title="Potencial OFF CMP 405", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
...
fig47.add_trace(go.Scatter(x=df47['fecha'], y=df47.ma10, mode="lines", marker_color='rgba(229, 45, 35, 1)',
                           name="Potencial OFF"), row=1, col=1)
fig47.update_layout(title="Potencial OFF CMP 412", coloraxis=dict(colorscale='Bluered_r'),
                    xaxis_title="Fecha [mm/dd/yyyy]", showlegend=True)
